...
#if defined(__4MHz_UBW_BOOTLOADER)
	#pragma config PLLDIV   = 1       // (4 MHz input)
	#pragma config CPUDIV   = OSC1_PLL2
	#pragma config USBDIV   = 2       // Clock source from 96MHz PLL/2
	#pragma config FOSC     = XTPLL_XT
#elif defined(__20MHz_UBW_BOOTLOADER)
	#pragma config PLLDIV   = 5       // (20 MHz input)
	#pragma config CPUDIV   = OSC1_PLL2
	#pragma config USBDIV   = 2       // Clock source from 96MHz PLL/2
	#pragma config FOSC     = HSPLL_HS
#elif defined(__24MHz_UBW_BOOTLOADER)
	#pragma config PLLDIV   = 6       // (24 MHz input)
	#pragma config CPUDIV   = OSC1_PLL2
	#pragma config USBDIV   = 2       // Clock source from 96MHz PLL/2
	#pragma config FOSC     = HSPLL_HS
#else
	#error "You MUST define one __XXMHz_UBW_BOOTLOADER"
#endif
